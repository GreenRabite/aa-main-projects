...
def permutations(array)
  ...
  # and for each permutation add first into every index. This new subarrayd
...
def make_change(target, coins = [25, 10, 5, 1])
  ...
  coins.each_with_index do |coin, index|
    ...
    # call). Wh y `coins.drop(index)`? This is an optimization. Because
